 ...
 * discovers every {@code @Produces Service} bean and mounts each
 * operation on Quarkus's main HTTP router via the upstream Vert.x
 * bridge — see ADR-0006 for the architecture and the README for the
 * config options.
 *
