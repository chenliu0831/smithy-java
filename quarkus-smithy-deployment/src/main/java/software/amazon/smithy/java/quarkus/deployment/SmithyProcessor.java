 ...
 * Quarkus's main Vert.x {@code Router} via the upstream Vert.x bridge
 * module. ADR-0006 describes the architecture; this class is the
 * Quarkus-specific glue.
 */
public final class SmithyProcessor {
     ...
     * {@link software.amazon.smithy.java.server.vertx.BridgeOptions},
     * and binds the bridge on the main Router.
     *
     ...
     * We fall back to {@code httpRouter} in that case so the bridge
