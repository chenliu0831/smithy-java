 ...
 * generation in the bridge module's tests.
 */
final class MenuFixture {
    ...
    /**
     * A second restJson1 service whose only operation also claims
     * {@code GET /menu}. Used to test bind-time collision detection.
     */
    static Service collidingMenuService() {
        return new CollidingMenuService();
    }

    static final class CollidingMenuService implements Service {
        private static final ShapeId COLL_SERVICE_ID = ShapeId.from("test#OtherMenu");
        private static final ShapeId COLL_OP_ID = ShapeId.from("test#OtherGetMenu");
        private static final Schema SCHEMA = Schema.createService(
                COLL_SERVICE_ID,
                (Trait) RestJson1Trait.builder().build());

        private final Operation<EmptyStruct, EmptyStruct> getMenu = Operation.of(
                "GetMenu",
                (input, ctx) -> EmptyStruct.INSTANCE,
                new StubApiOperation(COLL_OP_ID, http("GET", "/menu")),
                this);
        ...
        public <I extends SerializableStruct, O extends SerializableStruct> Operation<I, O> getOperation(
            ...
            return "GetMenu".equals(operationName) ? (Operation<I, O>) getMenu : null;
        }
    ...
    static final class EmptyStruct implements SerializableStruct {
        ...
        static final class Builder implements ShapeBuilder<EmptyStruct> {
            ...
            @Override
            public ShapeBuilder<EmptyStruct> deserialize(software.amazon.smithy.java.core.serde.ShapeDeserializer d) {
    ...
    private static HttpTrait http(String method, String uri) {
        return HttpTrait.builder()
                .method(method)
                .uri(software.amazon.smithy.model.pattern.UriPattern.parse(uri))
                .code(200)
                .build();
    }
    ...
    static final class MenuService implements Service {
        ...
        final java.util.concurrent.atomic.AtomicReference<String> lastInvoked =
