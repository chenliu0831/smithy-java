 ...
 * {@link software.amazon.smithy.java.server.vertx.BridgeOptions}. The
 ...
 * server (per ADR-0003). Use the standard {@code quarkus.http.*} keys
 * for those.
 */
...
public interface SmithyServerConfig {
    ...
    /**
     * Path prefix prepended to every Smithy operation route at bind
     * time. Absent (default) means operations mount at the path their
    ...
    /**
     * Bound on
     * {@link software.amazon.smithy.java.server.vertx.BoundBridge#shutdown()}.
     * Default: 10 seconds.
     */
    @WithDefault("10s")
